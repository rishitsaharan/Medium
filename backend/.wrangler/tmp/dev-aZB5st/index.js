...
// .wrangler/tmp/bundle-bil3oa/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/rishit1.saharan/Github/projects/medium/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "inlineSchemaHash": "7783d8d0af5cca54fb9ae35c01d3485aec7f3f34975d45760345dfd552f00cef",
      "copyEngine": false
    };
    config.dirname = "/";
...
// node_modules/@rishit.saharan/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@rishit.saharan/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-bil3oa/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-bil3oa/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userApiRouter.post("/signin", async (c) => {
  ...
  if (userExists) {
    const jwtToken = await sign2({ id: userExists.id }, c.env.JWT_SECRET);
    c.status(200);
    return c.json({
      message: "Signed In",
      token: jwtToken
...
var user_default = userApiRouter;
...
blogApiRouter.post("/", async (c) => {
  const body = await c.req.json();
  const { success } = import_medium_common2.blogContent.safeParse(body);
  if (!success) {
    c.status(403);
...
blogApiRouter.put("/", async (c) => {
  const body = await c.req.json();
  const { success } = import_medium_common2.blogUpdate.safeParse(body);
  if (!success) {
    c.status(403);
...
blogApiRouter.get("/:id", async (c) => {
  const param2 = c.req.param();
  const blogId = parseInt(param2.id);
  const prisma = c.get("Prisma");
...
var blog_default = blogApiRouter;
...
router.use("/*", cors());
router.route("/user/", user_default);
router.route("/blog/", blog_default);
var routes_default = router;

// src/index.ts
var app = new Hono2();
app.route("/api/v1", routes_default);
var src_default = app;
